...
u={title:{text:"安全威胁分析图",subtext:"Top10",x:"center"},tooltip:{trigger:"item",formatter:"{a} <br/>{b} : {c} ({d}%)"},
	legend:{orient:"vertical",x:"left",
	data:["威胁1","威胁2","威胁3","威胁4","威胁5","威胁6","威胁7","威胁8","威胁9","威胁10"]},
	calculable:!0,series:[{name:"访问来源",type:"pie",radius:"55%",center:["50%","60%"],
	data:[
	      {value:335,name:"威胁1"},{value:310,name:"威胁2"},{value:234,name:"威胁3"},
	      {value:135,name:"威胁4"},{value:1548,name:"威胁5"},
	      {value:335,name:"威胁6"},{value:310,name:"威胁7"},{value:234,name:"威胁8"},
	      {value:135,name:"威胁9"},{value:1548,name:"威胁10"}
