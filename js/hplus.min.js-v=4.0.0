...
$(document).ready(function() {
    ...
    $(".navbar-minimalize").click(function() {
    	$("#exchange").toggleClass("fa-angle-double-right"),
...
function() {
    $(this).width() < 769 && ($("body").addClass("mini-navbar"), $(".navbar-static-side").fadeIn()) && ($("#exchange").toggleClass("fa-angle-double-right"))
}),
$(function() {
